package etu1927.framework.utils;

import etu1927.framework.Mapping;
import etu1927.framework.FileUpload;
import etu1927.framework.servlet.ModelView;
import etu1927.annotation.url;
import etu1927.annotation.Scope;
            ...
            for (Part part : parts) {
                for (int i = 0; i < fields.length; i++) {
                    ...
                    if (field.getName().equals(part.getName())) {
                        if (field.getType().getName().equals("etu1927.framework.FileUpload")) {
